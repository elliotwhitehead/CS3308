...
response = urllib2.urlopen('https://api.darksky.net/forecast/7eca58979c247b83761dc2d4c49d8989/40.0150,-105.2705')
...
for state in states:
	response = urllib2.urlopen("https://api.darksky.net/forecast/7eca58979c247b83761dc2d4c49d8989/" + state['lat'] + ',' + state['long'])
	data = json.load(response)

	temp = data['currently']['temperature']

	if temp <= 10:
		print "$(\"#" + state['code']+ "\").css('fill', 'blue');"
	elif temp < 31:
		print "$(\"#" + state['code']+ "\").css('fill', 'cyan');"
	elif temp < 51:
		print "$(\"#" + state['code']+ "\").css('fill', 'green');"
	elif temp < 80:
		print "$(\"#" + state['code']+ "\").css('fill', 'orange');"
	else:
		print "$(\"#" + state['code']+ "\").css('fill', 'red');"
